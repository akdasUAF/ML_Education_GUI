<template>
    <div class="KMeans">
        ...
        <h2 align=left>(2). Scaling the dataset: </h2>
        ...
        <p align="width: 80%">Within-Cluster-Sum-of-Squares (WCSS) measures the sum of squared distances 
            between each point and the centroid of its assigned cluster. Lower values of WCSS indicate better clustering performance.</p>
        <br />
